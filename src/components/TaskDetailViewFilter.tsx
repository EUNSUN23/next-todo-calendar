    ...
    return (
        <section className='flex space-x-4 '>
            <div className='w-auto relative'> {/* 필터 - depth_1 */}
                <div className='flex space-x-1 items-center font-md px-2 py-1.5 cursor-pointer hover:border hover:border-[var(--color-gray-light-1)] hover:bg-[var(--color-neutral-light-1)]'> {/* 필터 1 타이틀 */}
                    <BsFilter/>
                    <span>전체</span>
                    <BiCaretDown className='hidden'/>
                </div>
                <div className='hidden w-full text-center absolute top-full left-0 font-md-400 cursor-pointer bg-white border border-[var(--color-gray-light-1)]'> {/* 필터 1 옵션 */}
            ...
            <div className='w-auto relative hidden'> {/* 필터 - depth_2 (참여자) */}
                <div className='flex space-x-1 items-center font-md px-3 py-1.5 cursor-pointer hover:border hover:border-[var(--color-gray-light-1)] hover:bg-[var(--color-neutral-light-1)]'> {/* 필터 1 타이틀 */}
                    <BsFilter/>
                    <span>선택</span>
                    <BiCaretDown/>
                </div>
